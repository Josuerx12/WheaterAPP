...
searchLocation.addEventListener("click", () => {
  ...
  api
    ...
    .then((weather) => {
      ...
      windDirection.innerHTML = `<p id="wind-direction"><i class="fa-solid fa-location-arrow" style="transform: rotate(${weatherData.current.wind_degree}%)!important"></i>${weatherData.current.wind_dir}</p>`;
      //humidity
